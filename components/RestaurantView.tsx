...
import ChipotleRestaurantView from "./restaurant-view/ChipotleRestaurantView";
...
export type RestaurantViewProps = {
    restaurantId: string;
...
export default function RestaurantView(props: RestaurantViewProps) {
    if (props.hasBuildYourOwn && props.restaurantId === "chipotle") {
        return <ChipotleRestaurantView {...props} />;
    }

    return <GenericRestaurantView {...props} />;
}

function GenericRestaurantView({
    restaurantId,
    restaurantName,
    restaurantLogo,
