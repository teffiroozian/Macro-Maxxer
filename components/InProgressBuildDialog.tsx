...
export default function InProgressBuildDialog() {
  ...
  return (
    <Dialog
      ...
      titleId="in-progress-build-dialog-title"
      descriptionId="in-progress-build-dialog-description"
    ...
    >
      <button
        ...
        className="absolute right-4 top-4 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-slate-400 transition hover:bg-slate-900/5 hover:text-slate-600 active:bg-slate-900/10 focus-ring"
      >
        <X className="h-4 w-4" strokeWidth={2.2} aria-hidden="true" />
      </button>
      <div className="pr-8">
        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Unfinished Build</p>
      ...
      <div className="mt-5 flex flex-col gap-2">
        ...
        <AppButton ref={keepEditingButtonRef} variant="secondary" size="md" onClick={cancelPendingNavigation}>
